...
/**
 * Minimal async loader for app icons: handles data: URIs, http(s), and ipfs:// URLs, with a
 * byte-bounded in-memory cache. All decoding runs on a worker thread. (Copied from the utxo wallet.)
 */
